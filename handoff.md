...
- 生成并提交 `docs/sbom-v5.8.0.json` 与 `docs/release-provenance-v5.8.0.json`。
- 提交源码、文档和验证脚本，构建 `taiji-office-setup-5.8.0.exe`、Blockmap 和 `latest.yml`，再执行正式发布门禁。
- 推送 `main` 并创建 GitHub Release `v5.8.0`；发布前不覆盖用户数据目录。

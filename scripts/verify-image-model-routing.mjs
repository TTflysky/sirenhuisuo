...
assert.match(settings, /getAssistantPrompt\(DEFAULT_ASSISTANT_PROMPT, DEFAULT_PROMPT_VERSION, PERSONA_MIGRATION_APPENDIX_V26\)/u, '总设置页必须使用当前人格迁移协议');
...
assert.match(persona, /DEFAULT_PROMPT_VERSION = '26'/u, '内置助理人格必须随版本升级');

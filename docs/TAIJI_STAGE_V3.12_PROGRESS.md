...
源码、内置人格和本机安装版已升级到 v3.12.0 / v25，核心回归、Windows 打包、覆盖安装和 GitHub Release 远端验收全部通过。
...
- GitHub Release：`https://github.com/TTflysky/sirenhuisuo/releases/tag/v3.12.0`。
- 发布提交：`8bdc5d0762cdb7e162582ca3675fce559e6875f8`；远端 `main`、标签和三项发布资产已通过大小与 SHA-256 核对。
...
- Electron 原生窗口自动截图仍受本机 GPU 子进程稳定性影响；当前使用浏览器渲染快照与安装版真实项目快照共同留证。
...
4. 在下一阶段继续真实长任务和多窗口回归，不把短时进程存活代替正式 8 小时驻留。

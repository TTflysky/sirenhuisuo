...
> 最后整理：2026-08-07
> 当前源码版本：`v5.8.0`；V5.8 自治评测内核与短驻留门禁已完成，连续 8 小时真实陪跑仍等待客户端启动后采集
> 主分支：`main`
> 仓库：[TTflysky/sirenhuisuo](https://github.com/TTflysky/sirenhuisuo)

## v5.8.0 当前交接（2026-08-07）
...
- 发布前需要生成并提交 V5.8 的 SBOM/provenance，构建安装包并运行正式发布脚本；发布后在“设置 -> 诊断中心 -> 自治陪跑评测”开始真实陪跑。

...
- [直接下载 v0.11.0 安装包](https://github.com/TTflysky/sirenhuisuo/releases/download/v0.11.0/taiji-office-setup-0.11.0.exe)
- [查看 v0.11.0 发布说明](https://github.com/TTflysky/sirenhuisuo/releases/tag/v0.11.0)

本地构建的安装程序生成在：

```text
release/taiji-office-setup-0.11.0.exe
```

...
- [直接下载 v0.8.3 安装包](https://github.com/TTflysky/sirenhuisuo/releases/download/v0.8.3/hermes-office-pro-setup-0.8.3.exe)
- [查看 v0.8.3 发布说明](https://github.com/TTflysky/sirenhuisuo/releases/tag/v0.8.3)

本地构建的安装程序生成在：

```text
release/hermes-office-pro-setup-0.8.3.exe
```

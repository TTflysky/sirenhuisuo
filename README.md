...
- 运行中可继续发送消息；执行策略支持“引导当前运行”或“排队处理”。
...
- [直接下载 v0.8.10 安装包](https://github.com/TTflysky/sirenhuisuo/releases/download/v0.8.10/hermes-office-pro-setup-0.8.10.exe)
- [查看 v0.8.10 发布说明](https://github.com/TTflysky/sirenhuisuo/releases/tag/v0.8.10)

本地构建的安装程序生成在：

```text
release/hermes-office-pro-setup-0.8.10.exe
```

...
`v0.21.0` 已完成构建与发布验收。源码和交接资料以 `main` 为准。

- [直接下载 v0.21.0 安装包](https://github.com/TTflysky/sirenhuisuo/releases/download/v0.21.0/taiji-office-setup-0.21.0.exe)
- [查看 v0.21.0 发布说明](https://github.com/TTflysky/sirenhuisuo/releases/tag/v0.21.0)

本地构建的安装程序生成在：

```text
release/taiji-office-setup-0.21.0.exe
```

...
- [直接下载 v0.7.17 安装包](https://github.com/TTflysky/sirenhuisuo/releases/download/v0.7.17/hermes-office-pro-setup-0.7.17.exe)
- [查看 v0.7.17 发布说明](https://github.com/TTflysky/sirenhuisuo/releases/tag/v0.7.17)

本地构建的安装程序生成在：

```text
release/hermes-office-pro-setup-0.7.17.exe
```

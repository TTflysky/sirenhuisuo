...
- 章北海人格只定义职责、工具和行为边界；用户画像由用户主动维护，不会被自动分析覆盖。
...
- [直接下载 v0.7.13 安装包](https://github.com/TTflysky/sirenhuisuo/releases/download/v0.7.13/hermes-office-pro-setup-0.7.13.exe)
- [查看 v0.7.13 发布说明](https://github.com/TTflysky/sirenhuisuo/releases/tag/v0.7.13)

本地构建的安装程序生成在：

```text
release/hermes-office-pro-setup-0.7.13.exe
```

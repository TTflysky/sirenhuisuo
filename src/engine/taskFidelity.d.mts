export interface TaskRequirement { id: string; kind: 'time' | 'location' | 'topic' | 'artifact' | 'entity' | 'resource' | 'web_interactive'; label: string; terms: string[]; evidencePattern?: RegExp }

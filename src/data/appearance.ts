...
export const FONT_OPTIONS: Array<{ value: FontKey; label: string; family: string }> = [
  ...
  { value: 'noto-sans', label: '思源黑体', family: "'Hermes Noto Sans SC', sans-serif" },
  { value: 'noto-serif', label: '思源宋体', family: "'Hermes Noto Serif SC', serif" },
  { value: 'source-han-regular', label: '思源黑体', family: "'Hermes Source Han Sans Regular', sans-serif" },
  { value: 'source-han-light', label: '思源黑体纤细', family: "'Hermes Source Han Sans Light', sans-serif" },
  { value: 'source-han-bold', label: '思源黑体粗体', family: "'Hermes Source Han Sans Bold', sans-serif" },
];

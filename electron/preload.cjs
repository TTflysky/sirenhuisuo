...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  taskExecutionObservability: (taskId) => ipcRenderer.invoke('task-execution:observability', taskId),
  diagnosticsRecord: (input) => ipcRenderer.invoke('diagnostics:record', input),
  diagnosticsQuery: (options) => ipcRenderer.invoke('diagnostics:query', options),
  ...
  telemetryQuery: (options) => ipcRenderer.invoke('telemetry:query', options),
  telemetrySummary: (options) => ipcRenderer.invoke('telemetry:summary', options),
  telemetryDashboard: (options) => ipcRenderer.invoke('telemetry:dashboard', options),
  telemetryExport: (options) => ipcRenderer.invoke('telemetry:export', options),
  ...
  skillsRuntime: () => ipcRenderer.invoke('skills:runtime'),
  skillsRuntimeHealth: () => ipcRenderer.invoke('skills:runtimeHealth'),
  skillsRuntimeInspect: (id) => ipcRenderer.invoke('skills:runtimeInspect', id),
  skillsRuntimeInvocation: (input) => ipcRenderer.invoke('skills:runtimeInvocation', input),
  skillsRuntimeInstall: (input) => ipcRenderer.invoke('skills:runtimeInstall', input),
  skillsRuntimeRepair: (id) => ipcRenderer.invoke('skills:runtimeRepair', id),
  skillDrafts: () => ipcRenderer.invoke('skills:drafts'),
  skillLifecycle: (input) => ipcRenderer.invoke('skills:lifecycle', input),
  rollbackAutoSkill: (input) => ipcRenderer.invoke('skills:rollbackAuto', input),
  ...
  memoryPropose: (input) => ipcRenderer.invoke('memory:propose', input),
  memoryRemove: (input) => ipcRenderer.invoke('memory:remove', input),
  memoryRollback: (input) => ipcRenderer.invoke('memory:rollback', input),
  ...
  credentialSave: (input) => ipcRenderer.invoke('credentials:save', input),
  credentialRead: (credentialRef) => ipcRenderer.invoke('credentials:read', credentialRef),
  credentialStatus: (credentialRef) => ipcRenderer.invoke('credentials:status', credentialRef),
  credentialDelete: (credentialRef) => ipcRenderer.invoke('credentials:delete', credentialRef),
